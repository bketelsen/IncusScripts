...
intel() {
  ...
  [ -z "$intel_microcode" ] && {
    whiptail --backtitle "Incus Scripts" --title "No Microcode Found" --msgbox "It appears there were no microcode packages found\n Try again later." 10 68
    msg_info "Exiting"
    sleep 1
    msg_ok "Done"
    exit
  ...
  [ -z "$microcode" ] && {
    whiptail --backtitle "Incus Scripts" --title "No Microcode Selected" --msgbox "It appears that no microcode packages were selected" 10 68
    msg_info "Exiting"
    sleep 1
    msg_ok "Done"
    exit
